...
import com.nx.nxapi.model.dto.post.PostAddRequest;
import com.nx.nxapi.model.dto.post.PostEditRequest;
import com.nx.nxapi.model.dto.post.PostQueryRequest;
import com.nx.nxapi.model.dto.post.PostUpdateRequest;
import com.nx.nxapi.model.entity.Post;
import com.nx.nxapi.model.entity.User;
import com.nx.nxapi.model.vo.PostVO;
...
public class PostController {
     ...
     * 创建
     *
     * @param postAddRequest post add request
     ...
     * 更新（仅管理员）
     *
     * @param postUpdateRequest post update request
     * @return {@link BaseResponse }<{@link Boolean }>
     */
    @PostMapping("/update")
     ...
     * 分页获取列表（仅管理员）
     *
     * @param postQueryRequest post query request
     ...
     * 编辑（用户）
     *
     * @param postEditRequest post edit request
     * @param request         request
     * @return {@link BaseResponse }<{@link Boolean }>
     */
    @PostMapping("/edit")
